...
# 自定义旋转填充（在mmseg/datasets/pipelines/transforms.py中添加）
class SmartRotate:
    def __init__(self, angle, fill_mode='reflect'):
        self.angle = angle
        self.fill_mode = fill_mode  # reflect|edge|mean
    ...
    def __call__(self, results):
        ...
        elif self.fill_mode == 'edge':
            borderMode = cv2.BORDER_REPLICATE
        else:
            borderMode = cv2.BORDER_CONSTANT
            fill_value = img.mean(axis=(0, 1))
